...
ana_flags=""
mkdir -p ${scratch_dir}/work1/${ana_prefix}
mkdir -p ${scratch_dir}/output1/${ana_prefix}
...
singularity run \
  ...
  ${fmriprep_container} \
      /scratch/hcp_example_bids_v4_phase_switchdir /scratch/output1/${ana_prefix} participant \
      --nthreads 40 \
      --omp-nthreads 40 \
      --use-aroma \
      ${ana_flags} \
      --output-space T1w template \
      --work-dir /scratch/work1/${ana_prefix} \
